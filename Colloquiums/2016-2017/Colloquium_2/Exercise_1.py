...
# w każdym kolejnym mieście. Alicja wybiera trasę oraz decyduje kto prowadzi pierwszy. Proszę zaproponować
# algorytm, który wskazuje taką trasę (oraz osobę, która ma prowadzić pierwsza), żeby Alicja przejechała
# jak najmniej kilometrów. Algorytm powinien być jak najszybszy (ale przede wszystkim poprawny). Proszę
# oszacować złożoność zaproponowanego algorytmu, zakładając, że graf jest reprezentowany macierzowo.
